...
public class AppUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		...
		Usuario usuario = usuarioOptional.orElseThrow(() -> new UsernameNotFoundException("E-mail e/ou senha incorretos."));
		return new org.springframework.security.core.userdetails.User(email, usuario.getSenha(), getPermissions(usuario));
	}
